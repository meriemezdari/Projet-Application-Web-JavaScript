...
form.addEventListener("submit", function (e) {
    ...
    //récupère les valeurs saisies dans le champs du formulaire
    ...
    afficherLivres(livres);//mis à jour des livres
    form.reset(); //vide le formulaire
});

function afficherLivres(tableau) {
    livresAjouter.innerHTML = ""; //vide la zone d'affichage
    ...
    tableau.forEach((livre, index) => {
        ...
        `;
        livresAjouter.appendChild(div); //ajoute la div
    });
}

recherche.addEventListener("input", function () { //à chaque caractère tapé 
